...
<main class="section">
    <div class="section is-medium">
        <h2 class="subtitle is-2 has-text-centered">Recent Post</h2>
    </div>
    <div class="container">
...
<section class="actions section is-medium">
    <div class="section">
        <div class="container has-text-centered flex-center">
        <p class="title subtitle is-1 is-capitalized">
        Sign up for our free news letter
        </p>
        <button class="button subtitle is-2 is-success">Sign Up Now</button>
...
<section class="section is-medium">
    <div class="container">
        <div class="section has-text-centered subtitle is-2">
            Our Team
        </div>
        <div class="columns padding-mediun">
