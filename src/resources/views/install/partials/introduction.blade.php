    ...
    <div class="column is-8 is-offset-2">
        ...
        <div class="content">
            ...
            <p class="">
                ...
                <a href="https://github.com/shawnsandy/jarvis-toolkit" class="headliners">Jarvis toolkit,</a> thats me :)
                yay. Now that we are buddies lets get started.
            </p>

            <p>
                I have tried to make this as simple as possible, however if you run into hiccups please feel free to read the
                <a href="/" class="docs-button">documentation</a> I have found it very helpful at times. Please hit
                <a href="/" class="start-button">lets get started</a> an we shall be on our way. </p>
            <p>
