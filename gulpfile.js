...
gulp.task('package', function () {
    return gulp.src('./src/resources/assets/**/*.*', {
            'base': './src/resources/assets/'
        })
...
gulp.task("clone:html", function () {
    git.clone("https://github.com/shawnsandy/frontend", {
        args: './html'
    }, function (err) {
        if (err) {
            toast.notify({
...
gulp.task("import:views", function () {
    return gulp.src("./html/theme/views/**/*.html", {
...
gulp.task("import:partials", function () {
    return gulp.src("./html/theme/views/partials/**/*.html", {
            "base": "./html/theme/views"
        })
        .pipe(replace(".blade.php", ".html"))
...
gulp.task("import:assets", function () {
    return gulp.src("./html/theme/public/**/*.*", {
            "base": "./html/public"
        })
